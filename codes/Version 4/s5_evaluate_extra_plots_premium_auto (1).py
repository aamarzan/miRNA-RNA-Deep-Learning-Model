...
def figS3_distribution_alignment(y_true,y_pred,out_dir,stdnames,cmap="magma"):
    ...
    # Colorbar moved farther to the right using axes_grid1
    divider = make_axes_locatable(ax)
    cax = divider.append_axes("right", size="4%", pad=0.40)
...
def figS6_interval_coverage(y_true,y_pred,out_dir,stdnames,cmap="cividis"):
    ...
    ax.set_title("Prediction Interval Coverage (points colored by |obs−nom|)", y=1.08)  # lifted title
